...
/*PandB Template*/				if(!extObj[i].namespace)	{
						if(extObj.callback && typeof extObj.callback == 'string')	{
/*PandB Template*/					extObj[i].callback.onError("Extension did not load because namespace ["+extObj[i].namespace+"] not set",'');
							}
/*PandB Template*/					_app.u.dump(" -> extension did not load because namespace ("+extObj[i].namespace+") was left blank.");
...
/*PandB Template*/					if(!extObj[i].filename){
